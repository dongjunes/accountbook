...
// Http 요청 준비 작업
        ...
        if (receive == 1) {
            ...
            http = new HttpClient.Builder("POST", "http://192.168.1.14:8088/account-book/android/" + id + "/deleteVo");
        } else if (receive == 8) {
            http = new HttpClient.Builder("POST", "http://192.168.1.14:8088/account-book/android/" + id + "/location");
        } else if (receive == 9) {
            ...
            http = new HttpClient.Builder("POST", "http://192.168.1.14:8088/account-book/android/" + id + "/findCategory");
        } else {
            http = new HttpClient.Builder("POST", "http://192.168.1.14:8088/account-book/android/" + id + "/findLimit");
